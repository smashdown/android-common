...
public class GifView extends View {
    ...
    private static final int DEFAULT_MOVIEW_DURATION = 1000000;
    ...
    private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.GifView, defStyle, android.R.style.Widget);
